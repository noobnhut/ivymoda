      ...
      <div class="auth-row">
        <div class="auth__login auth__block">
          ...
          <div class="auth__login__content">
            ...
            <div class="auth__form" role="login" name="frm_customer_account_email" >
              ...
              <div class="form-group">
                <input class="form-control" name="customer_password" type="password" placeholder="Mật khẩu" v-model="password">
              </div>
        ...
        <div class="auth__register auth__block">
          ...
          <div class="auth__login__content">
            ...
            <div class="auth__form__buttons">
              <router-link class="text-decoration-none" :to="{ name: 'register' }"><button class="btn btn--large">Đăng ký</button></router-link>
            </div>
          </div>
        </div>
      </div>
